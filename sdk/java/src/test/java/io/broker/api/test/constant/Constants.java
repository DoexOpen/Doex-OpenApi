...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: doex.com
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.doex.cloud
    ...
    // for example: wss://wsapi.doex.com/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.doex.com/openapi/ws
